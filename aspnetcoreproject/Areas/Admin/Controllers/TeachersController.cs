...
namespace aspnetcoreproject.Areas.Admin.Controllers
{
    ...
    public class TeachersController : Controller
    {
        ...
        public TeachersController(ConnectToDb context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var teacher = await _context.Teachers.Include(x=>x.Groups)
        ...
        public async Task<IActionResult> Create([Bind("Name,Surname")] Teacher teacher)
        {
